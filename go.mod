...
require (
	github.com/bnb-chain/versioned-state-database v0.0.0-20240809125757-b82bfd8d89d7
...
replace (
	#versioned-state-database => github.com/bnb-chain/versioned-state-database v0.0.0-20240809085816-0338449a56e8
